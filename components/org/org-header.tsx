...
export function OrgHeader({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <div className="flex items-center gap-4 border-b border-[#E9EFE6] px-[30px] py-[22px]">
      <div className="min-w-0">
        <h1 className="text-[23px] leading-[1.1] font-bold tracking-[-.02em]" style={{ fontFamily: displayFont }}>
          {title}
        </h1>
        <p className="mt-0.5 text-[12.5px] text-[#69746A]">{subtitle}</p>
      </div>
      ...
      <div
        className="flex h-11 w-11 items-center justify-center rounded-full text-[15px] font-extrabold text-white"
